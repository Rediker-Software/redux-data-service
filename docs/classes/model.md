...
*Defined in [Model/Model.ts:72](https://github.com/Rediker-Software/redux-data-service/blob/95a67d9/src/Model/Model.ts#L72)*
...
▸ **save**(progressSubscriber?: *`Subscriber`<`any`>*): `Promise`<[IModel](../interfaces/imodel.md)<`T`>>
