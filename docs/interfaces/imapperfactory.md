[redux-data-service](../README.md) > [IMapperFactory](../interfaces/imapperfactory.md)
...
*Defined in [Mapper/IMapper.ts:13](https://github.com/Rediker-Software/redux-data-service/blob/c6db69b/src/Mapper/IMapper.ts#L13)*
