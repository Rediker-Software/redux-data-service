...
var Mapper = (function () {
    ...
    Object.defineProperty(Mapper.prototype, "fields", {
        get: function () {
    ...
    Mapper.prototype.transformField = function (model) {
        var _this = this;
    ...
    Mapper.prototype.transform = function (model) {
    ...
    Mapper.prototype.transformPatch = function (model) {
        return __awaiter(this, void 0, void 0, function () {
            var original, updated;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.transform(model.original())];
                    case 1:
                        original = _a.sent();
                        return [4, this.transform(model)];
                    case 2:
                        updated = _a.sent();
                        return [2, jiff_1.diff(original, updated)];
                }
            });
        });
    };
    Mapper.prototype.transformList = function (models) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        transformedModels = models.map(function (model) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, this.transform(model)];
                                case 1: return [2, _a.sent()];
                            }
                        }); }); });
                        return [4, Promise.all(transformedModels)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    };
    Mapper.prototype.normalizeField = function (data) {
        var _this = this;
        return function (fieldType, fieldName) { return __awaiter(_this, void 0, void 0, function () {
            var value;
            return __generator(this, function (_a) {
    ...
    Mapper.prototype.normalize = function (data) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Mapper.prototype.normalizeQueryResponse = function (_a) {
        var items = _a.items, data = __rest(_a, ["items"]);
        return __awaiter(this, void 0, void 0, function () {
            var result, normalizedItems, _b;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        result = data;
                        return [4, items.map(function (item) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4, this.normalize(item)];
                                    case 1: return [2, _a.sent()];
                                }
                            }); }); })];
                    case 1:
                        normalizedItems = _c.sent();
                        _b = result;
                        return [4, Promise.all(normalizedItems)];
                    case 2:
                        _b.items = _c.sent();
                        result.ids = result.items.map(function (normalized) { return (normalized.id); });
                        return [2, result];
                }
            });
        });
    };
    Mapper.prototype.transformRelationship = function (fieldValue, relationship) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, promises;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            case Decorators_1.RelationshipType.BelongsTo: return [3, 1];
                            case Decorators_1.RelationshipType.HasMany: return [3, 3];
                        }
                        return [3, 5];
    ...
    Mapper.prototype.transformRelatedModel = function (relatedModel) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, ServiceProvider_1.getDataService(relatedModel.serviceName)
                            .mapper
    ...
    Mapper.prototype.processNestedRelationship = function (model, nestedData, relationship) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(relationship.type === Decorators_1.RelationshipType.BelongsTo)) return [3, 2];
                        return [4, this.loadRelatedModel(model, nestedData, relationship)];
                    case 1:
                        relatedModel = _a.sent();
                        return [2, relatedModel.id];
                    case 2:
                        if (!(relationship.type === Decorators_1.RelationshipType.HasMany && nestedData instanceof Array)) return [3, 4];
    ...
    Mapper.prototype.loadRelatedModel = function (model, relatedModelData, relationship) {
        return __awaiter(this, void 0, void 0, function () {
            var field, modelRelatedFieldName, service, relatedModel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, service.mapper.normalize(relatedModelData)];
                    case 1:
                        relatedModel = _a.sent();
