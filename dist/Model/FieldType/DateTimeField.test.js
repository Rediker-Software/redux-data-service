...
describe("FieldType: DateTimeField", function () {
    ...
    it("transforms a Date into its corresponding ISO string", function () { return __awaiter(_this, void 0, void 0, function () {
        var value, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    value = new Date();
                    _a = expect;
                    return [4, DateTimeField_1.DateTimeField.transform(value)];
                case 1:
                    _a.apply(void 0, [_b.sent()]).to.equal(value.toISOString());
                    return [2];
            }
        });
    }); });
    ...
    describe("normalize", function () {
        it("normalizes a Date ISO string into its corresponding Date object", function () { return __awaiter(_this, void 0, void 0, function () {
            var date, value, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = expect;
                        return [4, DateTimeField_1.DateTimeField.normalize(value)];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        date = new Date();
                        _a = expect;
                        return [4, DateTimeField_1.DateTimeField.normalize(date)];
                    case 1:
