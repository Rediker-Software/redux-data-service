...
describe("FieldType: StringField", function () {
    ...
    it("declares it's type", function () {
        return expect(StringField_1.StringField.type).to.eq("string");
    });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = expect;
                    return [4, StringField_1.StringField.normalize(randomNumber)];
                case 1:
    ...
    it("normalizes any null-like value into an empty string", function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = expect;
                    return [4, StringField_1.StringField.normalize(null)];
                case 1:
                    _a.apply(void 0, [_b.sent()]).to.be.a("string").and.to.equal("");
                    return [2];
            }
        });
    }); });
