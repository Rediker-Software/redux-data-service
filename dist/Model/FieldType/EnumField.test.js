    ...
    it("normalizes a value by returning the given value if it exists in the enum", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = expect;
                    return [4, EnumField.normalize("world")];
                case 1:
                    _a.apply(void 0, [_b.sent()]).to.equal(TestEnum.world);
                    return [2];
            }
        });
    }); });
    it("normalizes a value which does not exist in the enum by returning null", function () { return __awaiter(_this, void 0, void 0, function () {
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = expect;
                    return [4, EnumField.normalize("asdf")];
                case 1:
