...
var Model = (function () {
    ...
    Object.defineProperty(Model.prototype, "parentModelId", {
        get: function () {
            return lodash_1.get(this, this.parentIdFieldName);
        },
        set: function (value) {
            lodash_1.set(this, this.parentIdFieldName, value);
        },
        enumerable: true,
        configurable: true
    });
    Model.prototype.save = function (progressSubscriber) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.saveModel(progressSubscriber)];
    ...
    Model.prototype.saveModel = function (progressSubscriber) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (_this.serializeThroughParent) {
                var parentDataService = ServiceProvider_1.getDataService(_this.parentServiceName);
                parentDataService
                    .getById(_this.parentModelId)
                    .take(1)
                    .subscribe(function (parentModel) {
                    return parentModel.save().then(resolve, reject);
                });
            }
            else {
                var service = ServiceProvider_1.getDataService(_this.serviceName);
                var action = (_this.isNew)
                    ? service.actions.createRecord
                    : Configure_1.getConfiguration().preferPatchOverPut
                        ? service.actions.patchRecord
                        : service.actions.updateRecord;
                action({ id: _this.id, progressSubscriber: progressSubscriber }, {
    ...
    Model.prototype.delete = function () {
        ...
        return new Promise(function (resolve, reject) {
            var service = ServiceProvider_1.getDataService(_this.serviceName);
            var action = service.actions.deleteRecord;
            action({ id: _this.id }, {
                onSuccess: function (model) { return resolve(model); },
                onError: function (error) { return reject("xhr" in error ? error.xhr.response : error); },
            }).invoke();
    ...
    Model.prototype.reset = function () {
        if (this.isNew) {
            ...
            var service = ServiceProvider_1.getDataService(this.serviceName);
    ...
    Model.prototype.getRelated = function (fieldName) {
        ...
        var relatedIDorIDs = lodash_1.get(this, relationship.relatedFieldName);
        ...
        var _a = this, _b = _a.relatedModels, relatedModels = _b === void 0 ? {} : _b, id = _a.id;
        function observableSubscription(value) {
            if (relatedModels[fieldName] == null) {
                ...
                service
                    .actions
                    .setRelationship({ id: id, fieldName: fieldName, value: value })
                    .invoke();
            }
        }
        var service = ServiceProvider_1.getDataService(this.serviceName);
    ...
    Model.prototype.getServiceForRelationship = function (relationshipKey) {
        ...
        var serviceName = relationship.serviceNameField
            ? lodash_1.get(this, relationship.serviceNameField)
            : relationship.serviceName;
        return serviceName && ServiceProvider_1.getDataService(serviceName);
    };
    ...
    Model.prototype.getWillDestroyObservable$ = function () {
        if (!this.meta.willDestroyObservable$) {
            this.meta.willDestroyObservable$ = new Subject_1.Subject();
    ...
    __decorate([
        Decorators_1.attr(FieldType_1.BooleanField, { serialize: false, defaultValue: false }),
        __metadata("design:type", Boolean)
    ], Model.prototype, "serializeThroughParent", void 0);
    __decorate([
        Decorators_1.attr(FieldType_1.StringField, { serialize: false }),
        __metadata("design:type", Object)
    ], Model.prototype, "parentServiceName", void 0);
    __decorate([
        Decorators_1.attr(FieldType_1.StringField, { serialize: false, defaultValue: function (m) { return m.parentServiceName + "Id"; } }),
        __metadata("design:type", String)
    ], Model.prototype, "parentIdFieldName", void 0);
    return Model;
}());
exports.Model = Model;
