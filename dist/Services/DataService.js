    ...
    DataService.prototype.fetchAllEpic = function (action$, store) {
        ...
        return action$.ofType(this.types.FETCH_ALL)
            ...
            return _this.adapter.fetchAll(action.payload)
                .mergeMap(function (_a) { return __awaiter(_this, void 0, void 0, function () {
                var promises, _b, _c;
                var _this = this;
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            promises = items.map(function (item) { return _this.serializer.deserialize(item); });
                            _b = [{}, other];
                            _c = {};
                            return [4, Promise.all(promises)];
                        case 1: return [2, __assign.apply(void 0, _b.concat([(_c.items = _d.sent(), _c)]))];
                    }
                });
            }); })
    ...
    DataService.prototype.createRecordEpic = function (action$, store) {
        ...
        return action$.ofType(this.types.CREATE_RECORD)
            ...
            return of_1.of(_this.selectors.getItem(store.getState(), action.payload.id))
                ...
                switch (_a.label) {
                    case 0: return [4, this.serializer.serialize(model)];
                    case 1: return [2, _a.sent()];
                }
            }); }); })
