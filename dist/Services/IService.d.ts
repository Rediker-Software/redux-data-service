...
export declare type IObservableAction<T extends object = any, M = any> = ActionsObservable<IAction<T, M>> & IAction<T, M>;
export declare type IActionEpic<T extends object = any, M = any> = Epic<IObservableAction<T, M>, any, any>;
