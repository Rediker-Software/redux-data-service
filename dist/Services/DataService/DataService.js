...
var DataService = (function (_super) {
    ...
    DataService.prototype.createActions = function () {
        ...
        return __assign({}, actions, { createRecord: this.makeActionCreator(this.types.CREATE_RECORD), deleteRecord: this.makeActionCreator(this.types.DELETE_RECORD), fetchAll: this.makeActionCreator(this.types.FETCH_ALL), fetchRecord: this.makeActionCreator(this.types.FETCH_RECORD), patchRecord: this.makeActionCreator(this.types.PATCH_RECORD), pushAll: this.makeActionCreator(this.types.PUSH_ALL), pushRecord: this.makeActionCreator(this.types.PUSH_RECORD), unloadAll: this.makeActionCreator(this.types.UNLOAD_ALL), unloadRecord: this.makeActionCreator(this.types.UNLOAD_RECORD), updateRecord: this.makeActionCreator(this.types.UPDATE_RECORD), setField: this.makeActionCreator(this.types.SET_FIELD), setMetaField: this.makeActionCreator(this.types.SET_META_FIELD), setRelationship: this.makeActionCreator(this.types.SET_RELATIONSHIP), setQueryResponse: this.makeActionCreator(this.types.SET_QUERY_RESPONSE) });
    };
    ...
    DataService.prototype.fetchAllEpic = function (action$, store) {
        ...
        return action$.ofType(this.types.FETCH_ALL)
            ...
            return _this.adapter.fetchAll(_this.serializer.serializeQueryParams(action.payload.queryParams))
                ...
                .map(function (_a) {
                var items = _a.items;
                return _this.actions.pushAll({ items: items });
            })
                .concat(function (_a) {
                var items = _a.items, response = __rest(_a, ["items"]);
                return of_1.of(_this.actions.setQueryResponse({ query: action.payload, response: response }));
            })
    ...
    DataService.prototype.patchRecordEpic = function (action$) {
        ...
        return action$.ofType(this.types.PATCH_RECORD)
            ...
            return of_1.of(action.payload)
                ...
                .mergeMap(function (serializedModel) { return _this.adapter.patchItem(action.payload.id, serializedModel); })
                .mergeMap(function (response) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.serializer.deserialize(response)];
                    case 1: return [2, _a.sent()];
