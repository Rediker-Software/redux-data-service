...
describe("MemorySerializer", function () {
    ...
    it("serialize() returns the raw model data", function () { return __awaiter(_this, void 0, void 0, function () {
        var fakeModel, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    fakeModel = TestUtils_1.seedService("fakeModel");
                    _a = expect;
                    return [4, serializer.serialize(fakeModel)];
                case 1:
    ...
    it("deserialize() returns the model when given raw data", function () { return __awaiter(_this, void 0, void 0, function () {
        var fakeModel, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    fakeModel = TestUtils_1.seedService("fakeModel");
                    _a = expect;
                    return [4, serializer.deserialize(fakeModel.modelData)];
                case 1:
                    _a.apply(void 0, [_b.sent()])
